...
require_once("DAO/SettingCriteriaDAO.php");

/**
 * The SettingCriteria class extends SettingDAOCriteria and is used
 ...
 * @version 1.0
 */
class SettingCriteria extends SettingCriteriaDAO
{
