/**
 * backbone model definitions for Autoresponse
 */
 ...
 * Log Backbone Model
 */
model.LogModel = Backbone.Model.extend({
	urlRoot: 'api/log',
	idAttribute: 'id',
	id: '',
	from: '',
...
/**
 * Log Backbone Collection
 */
model.LogCollection = model.AbstractCollection.extend({
	url: 'api/logs',
...
/**
 * Topic Backbone Model
 */
model.TopicModel = Backbone.Model.extend({
	urlRoot: 'api/topic',
	idAttribute: 'id',
	id: '',
	keyword: '',
...
/**
 * Topic Backbone Collection
 */
model.TopicCollection = model.AbstractCollection.extend({
	url: 'api/topics',
