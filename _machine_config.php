...
GlobalConfig::$CONNECTION_SETTING->DBName = "autoresponse";
...
/** the root url of the application with trailing slash, for example http://localhost/autoresponse/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'autoresponse/';
