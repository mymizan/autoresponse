<?php
	$this->assign('title','Autoresponse | Settings');
	...
	<script type="text/template" id="settingModelTemplate">
		<form class="form-horizontal" onsubmit="return false;">
			<fieldset>
				...
				<div id="optionInputContainer" class="control-group">
					<label class="control-label" for="option">Option</label>
					<div class="controls inline-inputs">
						<input type="text" class="input-xlarge" id="option" placeholder="Option" value="<%= _.escape(item.get('option') || '') %>">
						<span class="help-inline"></span>
					</div>
				</div>
